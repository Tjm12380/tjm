      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="利润" prop="lirun">
          <el-input v-model="ruleForm.lirun" 
              placeholder="利润" clearable  :readonly="ro.lirun"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="利润" prop="lirun">
              <el-input v-model="ruleForm.lirun" 
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `lirunpaixingbang/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.lirunpaixingbangCrossAddOrUpdateFlag = false;
						 this.parent.search();
