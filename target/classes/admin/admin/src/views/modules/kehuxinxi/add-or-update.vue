<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="注册时间" prop="zhuceshijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zhuceshijian" label="注册时间" prop="zhuceshijian">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="是否会员" prop="shifouhuiyuan">
          <el-select :disabled="ro.shifouhuiyuan" v-model="ruleForm.shifouhuiyuan" placeholder="请选择是否会员">
            <el-option
                v-for="(item,index) in shifouhuiyuanOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="是否会员" prop="shifouhuiyuan">
	      <el-input v-model="ruleForm.shifouhuiyuan"
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhuceshijian = true;
          ...
          if(o=='shifouhuiyuan'){
            this.ruleForm.shifouhuiyuan = obj[o];
	    this.ro.shifouhuiyuan = true;
            continue;
          }
        }
      }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.shifouhuiyuanOptions = "是,否".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
