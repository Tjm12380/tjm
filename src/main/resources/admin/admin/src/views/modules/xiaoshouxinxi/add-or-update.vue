    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="折扣" prop="zhekou">
          <el-select :disabled="ro.zhekou" v-model="ruleForm.zhekou" placeholder="请选择折扣">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="实收金额" prop="shishoujine">
            <el-input v-model="shishoujine"
                placeholder="实收金额" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shishoujine" label="实收金额" prop="shishoujine">
              <el-input v-model="ruleForm.shishoujine" 
                placeholder="实收金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
...
export default {
  ...
  computed: {
    ...
    shishoujine:{
      get: function () {
        return 1*this.ruleForm.shuliang*this.ruleForm.shoujia*this.ruleForm.zhekou
      }
    },
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhekou = true;
          ...
          if(o=='shishoujine'){
            this.ruleForm.shishoujine = obj[o];
	    this.ro.shishoujine = true;
            continue;
          }
      ...
      this.$http({
		...
		if(json.xiaoshouxingming!=''&&json.xiaoshouxingming){
          ...
          this.$message.error(data.msg);
            ...
            this.zhekouOptions = "0.8,0.85,0.9,0.95".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
    ...
    // 提交
    onSubmit() {
        this.ruleForm.shishoujine = this.shishoujine
