<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="退货时间" prop="tuihuoshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.tuihuoshijian" 
                type="datetime"
                :readonly="ro.tuihuoshijian"
                placeholder="退货时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.tuihuoshijian" label="退货时间" prop="tuihuoshijian">
              <el-input v-model="ruleForm.tuihuoshijian" 
                placeholder="退货时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="仓管账号" prop="cangguanzhanghao">
          <el-input v-model="ruleForm.cangguanzhanghao" 
              placeholder="仓管账号" clearable  :readonly="ro.cangguanzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="仓管账号" prop="cangguanzhanghao">
              <el-input v-model="ruleForm.cangguanzhanghao" 
                placeholder="仓管账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="仓管姓名" prop="cangguanxingming">
          <el-input v-model="ruleForm.cangguanxingming" 
              placeholder="仓管姓名" clearable  :readonly="ro.cangguanxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="仓管姓名" prop="cangguanxingming">
              <el-input v-model="ruleForm.cangguanxingming" 
                placeholder="仓管姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.tuihuoshijian = this.getCurDateTime()
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shuliang = true;
          ...
          if(o=='tuihuoshijian'){
            this.ruleForm.tuihuoshijian = obj[o];
	    this.ro.tuihuoshijian = true;
            continue;
          }
          if(o=='tuihuoyuanyin'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.cangguanzhanghao!=''&&json.cangguanzhanghao){
                this.ruleForm.cangguanzhanghao = json.cangguanzhanghao
	    		this.ro.cangguanzhanghao = true;
		}
		if(json.cangguanxingming!=''&&json.cangguanxingming){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `tuihuoxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.tuihuoxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
