    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="供应产品" prop="gongyingchanpin">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="供应产品"
                  v-model="ruleForm.gongyingchanpin" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.gongyingchanpin" label="供应产品" prop="gongyingchanpin">
                    <span>{{ruleForm.gongyingchanpin}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.lianxifangshi = true;
          ...
          if(o=='gongyingchanpin'){
            this.ruleForm.gongyingchanpin = obj[o];
	    this.ro.gongyingchanpin = true;
            continue;
          }
        }
      }
