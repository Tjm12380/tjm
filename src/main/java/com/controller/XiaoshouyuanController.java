...
public class XiaoshouyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		XiaoshouyuanEntity user = xiaoshouyuanService.selectOne(new EntityWrapper<XiaoshouyuanEntity>().eq("xiaoshouzhanghao", username));
    ...
    public R register(@RequestBody XiaoshouyuanEntity xiaoshouyuan){
    	...
    	XiaoshouyuanEntity user = xiaoshouyuanService.selectOne(new EntityWrapper<XiaoshouyuanEntity>().eq("xiaoshouzhanghao", xiaoshouyuan.getXiaoshouzhanghao()));
		if(user!=null) {
